            ...
            <div class="d-flex align-center">
              <v-container>
                <v-card>
                  ...
                  the !Wordle in six guesses or less. <v-spacer></v-spacer>
                  <v-icon class="pa-1 my-2">mdi-check</v-icon> Letters can be
                  used more than once. <v-spacer></v-spacer>
                  ...
                  <v-spacer></v-spacer>
                  The A is IN the word but in the WRONG spot, the rest are not
                  in the word. <v-spacer></v-spacer>
                  ...
                  ></v-spacer>
                  The L, E is IN the word but in the WRONG spot, the rest are
                  not in the word.
                  <v-spacer></v-spacer>
