            ...
            <v-container >
              <v-card>
                <v-card-text>
                    ...
                    <!-- BASIC word -->
                    <v-btn color=success small class="pa-0 my-4">B</v-btn> 
                    <v-btn color=error small class="pa-0 my-4">A</v-btn> 
                    ...
                    The B is IN the word and in the CORRECT spot, the rest are not in the word <v-spacer></v-spacer>
